...
# and 'menu select mouse' completions.
autoload -Uz is-at-least
if ! is-at-least 5.1; then
  source "$HOME/Dotfiles/.zshrc.legacy"
  return
fi
...
# Prevent multiline commands from being saved to history
zshaddhistory() {
  [[ "$1" != *$'\n'* ]]
}
...
bindkey "^[OH" beginning-of-line    # Home (alternate escape code)
bindkey "^[OF" end-of-line          # End (alternate escape code)
