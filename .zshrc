...
# ZSH_THEME_RANDOM_CANDIDATES=( "af-magic" "agnoster" "terminalparty" "gnzh" )
...
plugins=(git gitfast git-escape-magic shrink-path bgnotify ansible git-extras jira pip ssh-agent sudo tmux)
