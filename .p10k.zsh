# Generated by Powerlevel10k configuration wizard on 2021-08-16 at 08:35 PDT.
...
# sharp tails, 2 lines, solid, no frame, light-ornaments, compact, fluent,
...
() {
  ...
  typeset -g POWERLEVEL9K_GOOGLE_APP_CRED_CLASSES=(
      # '*:*prod*:*'  PROD    # These values arxamples that are unlikely
      # '*:*test*:*'  TEST    # to match your needs. Customize them as needed.
      '*'             DEFAULT)
  ...
  function prompt_example() {
    if [[ "$MARS_ENV" == "prod" ]] then
      p10k segment -b 1 -f 3 -i '⭐' -t '--> PROD <-- '
    elif [[ "$MARS_ENV" == "devel" ]] && [[ -n "$MARS_KEYSPACE_ID" ]]; then
      p10k segment -b 1 -f 3 -i '⭐' -t '$KEY_SPACE_ID '
    fi
  }
